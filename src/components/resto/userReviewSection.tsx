    ...
    <div>
        <div className="px-4 md:px-24 lg:px-32 pb-32 w-full max-w-[1600px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div key={review.id || index} className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md
                                                        transition-all">
            ...
            (
            <div className="bg-gray-50/50 p-12 rounded-3xl text-center border border-dashed border-gray-200">
