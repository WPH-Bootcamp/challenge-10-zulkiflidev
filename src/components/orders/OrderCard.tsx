    ...
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-6 border-b border-gray-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 bg-gray-50 px-4 py-2 
          ...
          <div className={`px-4 py-2 rounded-xl text-sm font-bold ${
            order.status === 'done' ? 'bg-green-50 text-green-600' : 'bg-orange-50 text-orange-600'
          }`}>

            {order.status === 'done' ? 'Completed' : 'Processing'}
      ...
      <div className="p-6 space-y-6">
        ...
        <div key={idx} className="flex gap-6">
            {/* Resto Logo */}
            <div className="relative w-16 h-16 rounded-2xl overflow-hidden bg-gray-100 border 
                            border-gray-50 shrink-0">
            ...
            <div className="flex-1">
              ...
              <h3 className="font-bold text-lg 
                             text-neutral-950 mb-3">{restoGroup.restaurant?.name}
              </h3>
        ...
        <div className="flex items-center gap-6">
          <div className="text-right">
            <p className="text-xs text-gray-400 font-bold uppercase 
                          tracking-wider mb-1">Total Payment</p>
